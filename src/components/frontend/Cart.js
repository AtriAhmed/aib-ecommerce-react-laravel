            ...
            <div className="gx-card mx-0 align-items-center border-bottom border-200 row" key={idx}>
                <div className="py-3 col-8">
                    <div className="d-flex align-items-center">
                        <Link className='text-decoration-none text-reset' to={`/collections/${item.product.category.slug}/${item.product.slug}`}><img src={`http://localhost:8000/${item.product.image}`} alt={item.product.name} width="100" className="img-fluid rounded-1 me-3 d-none d-md-block"/></Link>
